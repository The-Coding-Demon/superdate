    ...
    <div class="p-2 MapDetails">
      ...
      <div class="p-3">
        ...
        <p>
          ...
          kilometers) until you reach junction 9. 8.At junction 9, take the A446
          exit to Coleshill/Birmingham (North & East). 9.Follow the A446 for
          approximately 2.5 miles (4 kilometers) until you see signs for the
          National Exhibition Centre (NEC) and Resorts World Birmingham. 10.Take
          the exit towards Resorts World Birmingham and follow the signs to Bear
          Grylls Adventure, which is located within Resorts World.
        </p>
      </div>
    </div>
  );
